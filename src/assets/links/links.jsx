...
import gopher from '../../assets/images/gofrs.png'
...
export const portfolioLinks = [
  {
    imageSrc: gopher,
    title: "GaugeLytics Backend (In Development)",
    techs: [["Go"], ["Docker"], ["CI/CD"], ["Docker"], ["MongoDB"]],
    linkCode: "https://github.com/yebrai/GaugeLytics-API",
    linkDemo: "https://github.com/yebrai/GaugeLytics-API/blob/main/README.md",
    description: "GaugeLytics, a platform designed with a modular microservices architecture, tracking and analyzing application performance through logs and metrics."
  },
  {
    imageSrc: lb,
    title: "Lectores Beta",
